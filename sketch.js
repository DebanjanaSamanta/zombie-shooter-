...
var losesnd,winsnd,explosionsnd;
...
function preload(){
  ...
  losesnd = loadSound("lose.mp3");
  winsnd = loadSound("win.mp3")
  explosionsnd = loadSound("explosion.mp3");
...
textSize(20)
fill("white")
text ("Score = " + score,displayWidth-210,displayHeight/2-180)

textSize(20)
fill("white")
text ("life = " + life,displayWidth-210,displayHeight/2-130)
